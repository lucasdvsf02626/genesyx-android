 ...
 *
 * Figures follow the client-approved typical vaginal-pH range (3.8–4.5, elevated >4.5).
 * Genesyx is a wellness app, not a medical device; no clinical/regulatory approval applies.
 */
enum class PhStatus(val label: String, val color: Color) {
    ...
    companion object {
        ...
        /** Value a fresh log entry opens on (mid healthy band). */
        const val DEFAULT = 4.2

        /** Typical healthy vaginal-pH band. Readings above [HEALTHY_MAX] are ELEVATED. */
